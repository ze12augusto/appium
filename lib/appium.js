...
Appium.prototype.configure = function (args, desiredCaps, cb) {
  ...
  if( deviceType === "android" ){
    ...
    AppiumController.launchAndroidEmulator( desiredCaps.platformVersion, function( error ){
      ...
      AppiumController.device = this.getNewDevice(deviceType);
      AppiumController.device.configure(args, desiredCaps, cb);
      AppiumController.device.onResetTimeout = function () { this.resetTimeout(); }.bind(this);
    });
  }else{
