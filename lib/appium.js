...
Appium.prototype.configure = function (args, desiredCaps, cb) {
  ...
  if( deviceType === "android" ){
    ...
    console.log("preparing for launchAndroidEmulatorToTest");
    var AppiumController = this;
    AppiumController.launchAndroidEmulator( desiredCaps.platformVersion, function(){
...
Appium.prototype.launchAndroidEmulator = function( platformVersion, callback ){
